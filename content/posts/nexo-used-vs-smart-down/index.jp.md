---
title: "[日常/車の選択] エンジニアの費用・リスク計算: 新型「ネクソ残価保証プログラム」 vs 「初代中古ネクソ」"
description: "水素EVの3年間の減価償却費をリアルに試算。新型ネクソの残価保証型プログラムと、値落ちしきった初代中古ネクソのどちらが実用的かを比較します。"
date: 2026-09-07T10:45:00+09:00
draft: false
tags: ["TheAllNewNexo", "NEXO", "ネクソ", "水素自動車", "EV", "中古車", "エンジニアの日常"]
aliases:
...
インフラエンジニアとして長年システムを運用していると、日常の買い物や車の選定においても、費用対効果とリスクを数字で細かく試算してしまう癖があります。

最近、通勤や客先訪問の足となる車両を検討する中で、現代自動車の燃料電池自動車（FCEV）「ネクソ（NEXO）」を有力候補に挙げました。

![沿岸道路を走る次世代ネクソ(The All-New NEXO)](images/the_all_new_nexo.jpg)

INITIUMコンセプトをベースにしたスクエアなSUVスタイルと先進的なピクセルライティングを備えた第2世代の新型ネクソには強い魅力を感じる一方、購入形態を現実的に精査すると深いジレンマに直面します:

> **「新車を満額（補助金適用後で実質約3,800万〜4,000万ウォン）で購入しても3年後の急速な減価償却が重い… 約1,500万ウォン前後まで値下がりした初代の中古ネクソを選ぶべきか？ それとも残価保証が付帯するプログラムで新型に乗るべきか？」**

3年間の運用を前提に試算した、現実的な選択基準を整理してみました。
